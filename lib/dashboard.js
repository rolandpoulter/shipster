// [index.js](index.html) > lib/dashboard.js

var expect = require('chai').expect,
    gulp = require('gulp');
    // hapi = require('hapi');

var common = global.common || require('./common.js').init({});

exports.init = function (self) {
  'use strict';

  self.domain = common.domain_setup('lib/dashboard', function () {
    require('../dashboard/gulpfile.js');
